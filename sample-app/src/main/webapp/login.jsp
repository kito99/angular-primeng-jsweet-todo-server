...
<template is="dom-bind" id="login">
    ...
    <paper-material>
        <paper-header-panel class="flex">
            ...
            <!-- Submit to the resource method that does not user a form bean and does not do validation -->
            <%--<form id="loginForm" method="post" action="${mvc.contextPath}${mvc.applicationPath}/login-no-validation"--%>
            <%--disable-native-valid>--%>

            <%--<!-- Submit to the resource method that uses a form bean and does validation -->--%>
